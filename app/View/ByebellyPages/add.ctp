...
<div class="page_title">
	...
	<input type="text" id="datepickerCongrats" size="30" readonly="readonly"  value="<?php if($byebelly_date != ''){
    		echo $byebelly_date; } ?>"/>
	...
	<p>comenzaron las contracciones.</p>
  	...
  	?>
  <input type="radio" name="data[ByebellyPage][itstarted]" value="1" <?php if($itstarted == 1){
	...
	<input type="radio" name="data[ByebellyPage][itstarted]" value="2" <?php if($itstarted == 2){
	echo 'checked="checked"'; } ?> />
	<label>
