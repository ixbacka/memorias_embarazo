<?php if($mayi == 'si'){ ?>
    ...
    <div class="CSPhotoSelector_dialog">
      ...
      <div class="CSPhotoSelector_form">
        ...
        <div class="CSPhotoSelector_footer CSPhotoSelector_clearfix">
          ...
          <div class="CSPhotoSelector_pageNumberContainer">Page <span id="CSPhotoSelector_pageNumber">1</span> / <span id="CSPhotoSelector_pageNumberTotal">1</span></div>
  ...
  <div class="content">
    ...
    <?php if(isset($moment['MomentPage']['title'])){
    ...
    <div class="page_title">
	    <div class="title_page">
		    <p><input type="text" name="data[MomentPage][title]" value="<?php if($title != ''){ echo $title; } ?>" maxlength="16"/></p>
	    </div>
    </div>
