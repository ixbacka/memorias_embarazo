...
function get_date_spanish( $time, $part = false, $formatDate = '' ){
  ...
  ?>
	...
	<span>
		...
		<textarea name="data[CongratsPage][details]" maxlength="400" id="CongratsPageDetails"><?php if(isset($congrats['CongratsPage']['details'])){ echo $congrats['CongratsPage']['details']; }?></textarea>
