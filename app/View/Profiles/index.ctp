<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('cover_photo'); ?></th>
			<th><?php echo $this->Paginator->sort('font'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['username']); ?>&nbsp;</td>
		...
		<td><?php echo h($profile['Profile']['cover_photo']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['font']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['theme']); ?>&nbsp;</td>
		<td class="actions">
