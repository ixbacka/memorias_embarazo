...
<div class="content">
  ...
  <div class="congratsPages form">
    ...
    <?php if(isset($firstvisit['FirstVisitPage']['gin'])){
      $gin = $firstvisit['FirstVisitPage']['gin'];
    } else{
      $gin = '';
    }
    echo $this->Form->input('gin', array('label' => 'Mi ginecólogo es: ' , 'after' => '</span>','between' => '<span>', 'value' => $gin )); 
    ...
    <div class="input date">
      ...
      <span><input type="text" id="datepickerCongrats" size="30" readonly="readonly"  value="<?php if($estimated != ''){ echo $estimated; } ?>"/></span>
    ...
    <div class="row cf">
      <?php if(isset($firstvisit['FirstVisitPage']['weight'])) {
    ...
    <?php echo $this->Form->input('firstvisit',array('label' => 'Lo que recuerdo de mi primera visita es: ', 'after' => '</span>','between' => '<span>', 'value' => $firstvisit)); 
      /*
