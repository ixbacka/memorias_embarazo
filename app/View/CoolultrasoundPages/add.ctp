...
<div class="page_title">
	...
	<p>En este trimestre tu pap&aacute; est&aacute; un poco: </p>
 	<?php
  	...
  	?>
  <input type="radio" name="data[CoolultrasoundPage][urdad]" value="1" <?php if($urdad == 1){
	echo 'checked="checked"'; } ?> />
	<label>Agobiado</label>
 	<input type="radio" name="data[CoolultrasoundPage][urdad]" value="2" <?php if($urdad == 2){
  echo 'checked="checked"'; } ?> />
  <label>Sobreprotector</label>
 	<input type="radio" name="data[CoolultrasoundPage][urdad]" value="3" <?php if($urdad == 3){
  echo 'checked="checked"'; } ?> />
  <label>Excluido</label>
   	<input type="radio" name="data[CoolultrasoundPage][urdad]" value="4" <?php if($urdad == 4){
  echo 'checked="checked"'; } ?> />
  ...
  <input type="text" name="data[CoolultrasoundPage][imiss]" value="<?php if($imiss != ""){ echo $imiss; } ?>" />
	...
	<p>La gente que opina de mi panza: </p>
 	<?php
