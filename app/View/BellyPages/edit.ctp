...
<?php echo $this->Form->create('BellyPage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Belly Page'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BellyPage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BellyPage.id'))); ?></li>
