...
<?php echo $this->Form->create('SintomPage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sintom Page'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SintomPage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SintomPage.id'))); ?></li>
