...
/**
 * ByebellyPages Controller
 *
 */
class ByebellyPagesController extends AppController {

	var $uses = array('ByebellyPage','Profile');
	...
	public function add(){
      ...
      if ($this->request->is('post') || $this->request->is('put')) {
        ...
        $idf = $this->ByebellyPage->find('first', array( 'conditions' => array( 'ByebellyPage.profile_id' =>  $leid ) ) );
        
        if( !empty($idf['ByebellyPage']['id']) && !is_null($idf['ByebellyPage']['id'])){
          $this->ByebellyPage->id = $idf['ByebellyPage']['id'];
        }

        if ($this->ByebellyPage->save($this->request->data)) {
