...
/**
 * SpecialdeliveryPages Controller
 *
 */
class SpecialdeliveryPagesController extends AppController {

	var $uses = array('SpecialdeliveryPage','Profile');
	...
	public function add(){
      ...
      if ($this->request->is('post') || $this->request->is('put')) {
        ...
        $idf = $this->SpecialdeliveryPage->find('first', array( 'conditions' => array( 'SpecialdeliveryPage.profile_id' =>  $leid ) ) );
        
        if( !empty($idf['SpecialdeliveryPage']['id']) && !is_null($idf['SpecialdeliveryPage']['id'])){
          $this->SpecialdeliveryPage->id = $idf['SpecialdeliveryPage']['id'];
        }
